...
-- number-of-unique-subjects-taught-by-each-teacher/description/
--
-- database
-- Easy (89.86%)
-- Likes:    32
...
-- Testcase Example:  '{"headers":{"Teacher":["teacher_id","subject_id",
-- "dept_id"]},"rows":{"Teacher":[[1,2,3],[1,2,4],[1,3,3],[2,1,1],[2,2,1],[2,3,
-- 1],[2,4,1]]}}'
--
-- Table: Teacher
--
