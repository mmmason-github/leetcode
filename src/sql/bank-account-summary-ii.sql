...
-- Testcase Example:  '{"headers": {"Users": ["account", "name"],
-- "Transactions": ["trans_id", "account", "amount", "transacted_on"]}, "rows":
-- {"Users": [[900001, "Alice"], [900002, "Bob"], [900003, "Charlie"]],
-- "Transactions": [[1, 900001, 7000, "2020-08-01"], [2, 900001, 7000,
-- "2020-09-01"], [3, 900001, -3000, "2020-09-02"], [4, 900002, 1000,
-- "2020-09-12"], [5, 900003, 6000, "2020-08-07"], [6, 900003, 6000,
-- "2020-09-07"], [7, 900003, -4000, "2020-09-11"]]}}'
--
-- Table: Users
--
--
